---
paths:
  - "src/ALCops.Common/RecordMethodClassification.cs"
---
...
grep `RecordMethodClassification` for consumers. Note that AC0027 `TableDataAccessRequiresPermissions` uses `MethodOperationMap` directly, not this class.
