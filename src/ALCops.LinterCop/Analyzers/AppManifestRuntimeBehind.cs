...
[DiagnosticAnalyzer]
public sealed class AppManifestRuntimeBehind : DiagnosticAnalyzer
{
    public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics { get; } =
        ImmutableArray.Create(
            DiagnosticDescriptors.AppManifestRuntimeBehind);

    private static readonly SortedList<Version, Version> SupportedRuntimeVersionList = GetSupportedRuntimeVersions();

    public override void Initialize(AnalysisContext context) =>
        context.RegisterCompilationAction(CheckAppManifestRuntime);
