...
public static class EnumProvider
{
    ...
    public static class NavTypeKind
    {
        ...
        private static readonly Lazy<NavCodeAnalysis.NavTypeKind> _fieldRef =
            new(() => ParseEnum<NavCodeAnalysis.NavTypeKind>(nameof(NavCodeAnalysis.NavTypeKind.FieldRef)));
        private static readonly Lazy<NavCodeAnalysis.NavTypeKind> _filterPageBuilder =
            new(() => ParseEnum<NavCodeAnalysis.NavTypeKind>(nameof(NavCodeAnalysis.NavTypeKind.FilterPageBuilder)));
        ...
        public static NavCodeAnalysis.NavTypeKind FieldRef => _fieldRef.Value;
        public static NavCodeAnalysis.NavTypeKind FilterPageBuilder => _filterPageBuilder.Value;
    ...
    public static class PropertyKind
    {
        ...
        private static readonly Lazy<NavCodeAnalysis.PropertyKind> _summary =
            new(() => ParseEnum<NavCodeAnalysis.PropertyKind>(nameof(NavCodeAnalysis.PropertyKind.Summary)));
