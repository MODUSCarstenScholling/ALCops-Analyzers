...
public sealed class EventPublisherIsHandledByVarCodeFix : CodeFixProvider
{
    private class EventPublisherIsHandledByVarCodeAction : CodeAction.DocumentChangeAction
    {
        ...
        public EventPublisherIsHandledByVarCodeAction(string title,
    ...
    public sealed override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticDescriptors.EventPublisherIsHandledByVar.Id);
    ...
    private static EventPublisherIsHandledByVarCodeAction CreateCodeAction(SyntaxNode node, Document document, bool generateFixAll)
    {
        return new EventPublisherIsHandledByVarCodeAction(
            PlatformCopAnalyzers.EventPublisherIsHandledByVarCodeAction,
            ct => AddVarKeywordToParameter(document, node, ct),
            nameof(EventPublisherIsHandledByVarCodeFix),
            generateFixAll);
    }
